...
\begin{figure}
\centering
\includegraphics{workingDec.v4_files/figure-latex/FigureOne-1.pdf}
\caption{\label{fig:FigureOne}I wrote this.}
\end{figure}

Consider the pretty data plotted in Figure \ref{fig:FigureOne}.

\includegraphics{workingDec.v4_files/figure-latex/unnamed-chunk-1-1.pdf}
\includegraphics{workingDec.v4_files/figure-latex/unnamed-chunk-1-2.pdf}
\includegraphics{workingDec.v4_files/figure-latex/unnamed-chunk-1-3.pdf}
