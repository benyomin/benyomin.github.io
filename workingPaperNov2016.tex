...
\begin{figure}
\centering
\includegraphics{workingPaperNov2016_files/figure-latex/FigureOne-1.pdf}
\caption{\label{fig:FigureOne}I wrote this.}
\end{figure}

Consider the pretty data plotted in Figure \ref{fig:FigureOne}.

\includegraphics{workingPaperNov2016_files/figure-latex/unnamed-chunk-1-1.pdf}
\includegraphics{workingPaperNov2016_files/figure-latex/unnamed-chunk-1-2.pdf}
\includegraphics{workingPaperNov2016_files/figure-latex/unnamed-chunk-1-3.pdf}
